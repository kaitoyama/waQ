    ...
    try {
      ...
      if (values.thumbnail?.[0]) {
        ...
        thumbnailBase64 = await new Promise((resolve) => {
          ...
          reader.readAsDataURL(values.thumbnail[0])
        })
      }
                ...
                <div className="space-y-4 py-2">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between space-y-0">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base text-black">自動開始</FormLabel>
                          <FormDescription>データが送信され始めたら配信を開始します</FormDescription>
                        </div>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between space-y-0">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base text-black">自動終了</FormLabel>
                          <FormDescription>データが送信されなくなったら配信を終了します</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
